...
LDAUL        = -1 $l -1
LDAUU        = 0.00 $v 0.00  #for LDAUTYPE=3, LDAUU and LDAUJ denote the shifts acting on the up and down electrons, respectively
LDAUJ        = 0.00 $v 0.00  #LDAUU and LDAUJ should be identical
LDAUPRINT    =  2
!
